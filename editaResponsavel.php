...
{  
  ...
  $responsavel->setEmailResponsavel($listaId["emailResponsavel"]);
  $responsavel->setCelullarResponsavel($listaId["celullarResponsavel"]);
  $responsavel->setTelFixoResponsavel($listaId["telFixoResponsavel"]);
  $responsavel->setDtNascResponsavel($listaId["dtNascResponsavel"]); 
  $responsavel->setSexoResponsavel($listaId["sexoResponsavel"]); 
  $responsavel->setLogradouroEndeResponsavel($listaId["logradouroEndeResponsavel"]); 
  $responsavel->setComplementoEndeResponsavel($listaId["complementoEndeResponsavel"]);
  $responsavel->setBairroEndeResponsavel($listaId["bairroEndeResponsavel"]);
  $responsavel->setCidadeEndeResponsavel($listaId["cidadeEndeResponsavel"]);
  $responsavel->setUfEndeResponsavel($listaId["ufEndeResponsavel"]);
            ...
            <form action="salvaResponsavel.php?acao=<?php echo $acao; ?>" method="POST"
              ...
              <div class="form-group row">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-7">
                    <input type="text" name="cpfResponsavel" id="cpfResponsavel" class="form-control" required=""
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-5">
                  <input type="email" name="emailResponsavel" id="emailResponsavel" class="form-control" required=""
                    value="<?php echo $responsavel->getEmailResponsavel();?>" />
                </div>

                <div class="form-group row">
                  <label class="col-sm-2 form-control-label" for="celullarResponsavel">Celular:</label>
                  <div class="col-sm-8">
                    <input type="text" name="celullarResponsavel" id="celullarResponsavel" class="form-control"
                      required="" value="<?php echo $responsavel->getCelullarResponsavel();?>" />
                  </div>
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="form-group row">
                  <label class="col-sm-4 form-control-label" for="dtNascResponsavel">Data Nascimento:</label>
                  <div class="col-sm-">
                    <input type="date" name="dtNascResponsavel" id="dtNascResponsavel" placeholder="dd/mm/aaaa"
                      class="form-control" required="" value="<?php echo $responsavel->getDtNascResponsavel();?>" />
                  </div>
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="form-group row">
                  <label class="col-sm- form-control-label" for="logradouroEndeResponsavel">Logradouro:</label>
                  <div class="col-sm-8">
                    <input type="text" name="logradouroEndeResponsavel" id="logradouroEndeResponsavel"
              ...
              <div class="form-group row">
                <label class="col-sm- form-control-label" for="complementoEndeResponsavel">Complemento:</label>
                <div class="col-sm-4">
                ...
                <div class="form-group row">
                  <label class="col-sm-2 form-control-label" for="bairroEndeResponsavel">Bairro:</label>
                  <div class="col-sm-6">
                    <input type="text" name="bairroEndeResponsavel" id="bairroEndeResponsavel" class="form-control"
                      required="" value="<?php echo $responsavel->getBairroEndeResponsavel(); ?>" />
                  </div>
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-3">
                  <input type="text" name="cidadeEndeResponsavel" id="cidadeEndeResponsavel" class="form-control"
                    required="" value="<?php echo $responsavel->getCidadeEndeResponsavel(); ?>" />
                </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-2">
                  <input type="text" name="numeroEndeResponsavel" id="numeroEndeResponsavel" class="form-control"
                    required="" value="<?php echo $responsavel->getNumeroEndeResponsavel(); ?>" />
                </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-4">
                  <input type="password" name="senhaResponsavel" id="senhaResponsavel" class="form-control" required=""
