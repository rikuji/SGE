                    ...
                    <div class="cards">
                        <div class="card-header d-flex align-items-rigth" style="border-radius: 8px;">
                            ...
                            <a href="principal.php" class="btn btn-warning col-sm-2"
                                style="margin-left: auto; padding: 15px; background-color: #0b56a6;">Voltar</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="card">
						...
						$lista = $professorDAO->listarProfessor($professor);?>
                                    <tr>
                                        ...
                                        <td><?php echo "    ";?></td>
                                        <td>
                                            <a href="novoProfessor.php?acao=Editar&idProfessor=<?php echo $professor->getIdProfessor(); ?>"
                                                class="btn btn-warning" data-toggle="tooltip" data-placement="top"
                                                title="Editar">
                                                <i class="fa fa-pencil" aria-hidden="true"></i>
                                            </a>
                                            <a href="#" class="btn btn-danger"
                                                onclick="return excluir('salvaProfessor.php?acao=Deletar&idProfessor=<?php echo $professor->getIdProfessor(); ?>')"
