              ...
              <div class="form-group row">
               ...
               <div class="form-group row">
                <label class="col-sm-1 form-control-label" for="cpfAluno">CPF:</label>
                  <div class="col-sm-9">
                    <input type="text"  name="cpfAluno" maxlength="11" id="cpfAluno" class="form-control" required="" value="" placeholder="EX: 12345678901" />
               </div></div>
          </div>
               ...
               <div class="form-group row">
                <label class="col-sm-2 form-control-label" for="celullarAluno">Celular:</label>
                  <div class="col-sm-8">
                    <input type="number"  name="celullarAluno" id="celullarAluno" class="form-control" required="" value="" placeholder="EX:(00)9 9999-8888"/>
               </div></div>
          </div>
               ...
               <div class="form-group row">
                <label  class="form-control-label" for="dtNascAluno">Data Nascimento:</label>
                  <div class="col-sm-3">
                    <input type="date"  name="dtNascAluno" id="dtNascAluno" class="form-control" required="" value="" placeholder="dd/mm/aaaa" />
               </div>
            ...
            <div class="form-group row">
               ...
               <div class="form-group row">
                <label class=" form-control-label" for="numeroEndeAluno">Numero:</label>
                  <div class="col-sm-3">
                    <input type="number"  name="numeroEndeAluno" id="numeroEndeAluno" class="form-control" required="" value=""/>
               </div>
